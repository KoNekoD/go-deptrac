...
type AstMapExtractor struct {
	inputCollector collectors.InputCollectorInterface
	astLoader      *AstLoader
	astMapCache    *AstMap
}

func NewAstMapExtractor(inputCollector collectors.InputCollectorInterface, astLoader *AstLoader) *AstMapExtractor {
