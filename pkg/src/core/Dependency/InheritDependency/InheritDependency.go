...
type InheritDependency struct {
	depender           *AstMap.ClassLikeToken
	dependent          TokenInterface.TokenInterface
	originalDependency DependencyInterface.DependencyInterface
	inheritPath        *AstMap.AstInherit
}

func NewInheritDependency(depender *AstMap.ClassLikeToken, dependent TokenInterface.TokenInterface, originalDependency DependencyInterface.DependencyInterface, inheritPath *AstMap.AstInherit) *InheritDependency {
