...
type LayerCollector struct {
	resolver LayerResolverInterface.LayerResolverInterface
	resolved map[string]map[string]*bool
}

func NewLayerCollector(resolver LayerResolverInterface.LayerResolverInterface) *LayerCollector {
