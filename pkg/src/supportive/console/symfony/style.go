...
func (s *Style) Success(message output_formatter.StringOrArrayOfStrings) {
	color.Printf("<success>%s</>", message.ToString())
}

func (s *Style) Error(message output_formatter.StringOrArrayOfStrings) {
	color.Printf("<error>%s</>", message.ToString())
}

func (s *Style) Warning(message output_formatter.StringOrArrayOfStrings) {
	color.Printf("<warning>%s</>", message.ToString())
}

func (s *Style) Note(message output_formatter.StringOrArrayOfStrings) {
	color.Printf("<note>%s</>", message.ToString())
}

func (s *Style) Caution(message output_formatter.StringOrArrayOfStrings) {
	color.Printf("<danger>%s</>", message.ToString())
}

func (s *Style) DefinitionList(list []output_formatter.StringOrArrayOfStringsOrTableSeparator) {
