...
import (
	"flag"
	"github.com/KoNekoD/go-deptrac/pkg/src/supportive/console"
	"github.com/KoNekoD/go-deptrac/pkg/src/supportive/dependency_injection"
...
func (a *Application) doRun() (int, error) {
	...
	if err != nil {
		return 0, console.NewCannotGetCurrentWorkingDirectoryExceptionCannotGetCWD()
	}
