package InvalidCollectorDefinitionException
...
func NewInvalidCollectorDefinitionExceptionUnsupportedType(collectorType CollectorType.CollectorType, supportedTypes []CollectorType.CollectorType, previous error) *InvalidCollectorDefinitionException {
