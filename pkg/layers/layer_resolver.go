...
type LayerResolver struct {
	collectorResolver collectors.CollectorResolverInterface
	layersConfig      []*Layer
...
func NewLayerResolver(collectorResolver collectors.CollectorResolverInterface, layersConfig []*Layer) LayerResolverInterface {
