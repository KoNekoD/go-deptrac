...
func (c SuperglobalCollector) Satisfy(config map[string]interface{}, reference tokens_references.TokenReferenceInterface) (bool, error) {
	if _, ok := reference.(*tokens_references.VariableReference); !ok {
		return false, nil
	}
