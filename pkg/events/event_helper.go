...
func (e *EventHelper) AddSkippableViolation(event *ProcessEvent, analysisResult *rules.AnalysisResult, dependentLayer string, violationCreatingRule violations.ViolationCreatingInterface) {
