...
import (
	...
	astParser "github.com/KoNekoD/go-deptrac/pkg/ast_core/parser"
...
func (p *parsedFilesBag) Add(fileReference *ast_map2.FileReference, rootNode *ast.File) {
...
type parsedFile struct {
	fileReference *ast_map2.FileReference
	rootNode      *ast.File
	debt          []interface{}
}
...
func (p *NikicPhpParser) ParseFile(file string) (*ast_map2.FileReference, error) {
	...
	fileReferenceBuilder := ast_map2.CreateFileReferenceBuilder(file)
...
func (p *NikicPhpParser) GetNodeForClassLikeReference(classReference *ast_map2.ClassLikeReference) *ast.Ident {
