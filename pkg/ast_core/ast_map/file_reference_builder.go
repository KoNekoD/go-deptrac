...
func (b *FileReferenceBuilder) UseStatement(classLikeName string, occursAtLine int) *FileReferenceBuilder {
	b.Dependencies = append(b.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), b.CreateContext(occursAtLine, ast_contract.DependencyTypeUse)))
	return b
}
