...
type AstInherit struct {
	...
	FileOccurrence *ast_contract.FileOccurrence
	Type           AstInheritType
	path           []*AstInherit
}

func NewAstInherit(classLikeName *ClassLikeToken, fileOccurrence *ast_contract.FileOccurrence, astInheritType AstInheritType, path []*AstInherit) *AstInherit {
	return &AstInherit{
