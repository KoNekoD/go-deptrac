...
type ReferenceBuilderInterface interface {
	...
	CreateContext(occursAtLine int, dependencyType ast_contract2.DependencyType) *ast_contract2.DependencyContext
...
func (r *ReferenceBuilder) CreateContext(occursAtLine int, dependencyType ast_contract2.DependencyType) *ast_contract2.DependencyContext {
	return ast_contract2.NewDependencyContext(ast_contract2.NewFileOccurrence(r.Filepath, occursAtLine), dependencyType)
}
...
func (r *ReferenceBuilder) UnresolvedFunctionCall(functionName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewFunctionTokenFromFQCN(functionName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeUnresolvedFunctionCall)))
	return r
}

func (r *ReferenceBuilder) Variable(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeVariable)))
	return r
}

func (r *ReferenceBuilder) Superglobal(superglobalName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewSuperGlobalToken(superglobalName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeSuperGlobalVariable)))
	return r
}

func (r *ReferenceBuilder) ReturnType(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeReturnType)))
	return r
}

func (r *ReferenceBuilder) ThrowStatement(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeThrow)))
	return r
}

func (r *ReferenceBuilder) AnonymousClassExtends(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeAnonymousClassExtends)))
	return r
}

func (r *ReferenceBuilder) AnonymousClassTrait(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeAnonymousClassTrait)))
	return r
}

func (r *ReferenceBuilder) ConstFetch(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeConst)))
	return r
}

func (r *ReferenceBuilder) AnonymousClassImplements(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeAnonymousClassImplements)))
	return r
}

func (r *ReferenceBuilder) Parameter(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeParameter)))
	return r
}

func (r *ReferenceBuilder) Attribute(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeAttribute)))
	return r
}

func (r *ReferenceBuilder) Instanceof(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeInstanceof)))
	return r
}

func (r *ReferenceBuilder) NewStatement(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeNew)))
	return r
}

func (r *ReferenceBuilder) StaticProperty(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeStaticProperty)))
	return r
}

func (r *ReferenceBuilder) StaticMethod(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeStaticMethod)))
	return r
}

func (r *ReferenceBuilder) CatchStmt(classLikeName string, occursAtLine int) *ReferenceBuilder {
	r.Dependencies = append(r.Dependencies, NewDependencyToken(NewClassLikeTokenFromFQCN(classLikeName), r.CreateContext(occursAtLine, ast_contract2.DependencyTypeCatch)))
	return r
}
