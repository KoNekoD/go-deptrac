...
func (s *Style) Error(message output_formatter_contract.StringOrArrayOfStrings) {
...
func (s *Style) Caution(message output_formatter_contract.StringOrArrayOfStrings) {
	color.Printf("<danger>%s</>", message.ToString())
}

func (s *Style) DefinitionList(list []output_formatter_contract.StringOrArrayOfStringsOrTableSeparator) {
