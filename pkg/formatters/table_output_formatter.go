...
func (t *TableOutputFormatter) printSummary(result *results.OutputResult, output results.OutputInterface, reportUncoveredAsError bool) {
...
func (t *TableOutputFormatter) printErrors(result *results.OutputResult, output results.OutputInterface) {
...
func (t *TableOutputFormatter) printWarnings(result *results.OutputResult, output results.OutputInterface) {
