...
import (
	"fmt"
	"github.com/KoNekoD/go-deptrac/pkg/config_contract/formatter"
...
func (f *MermaidJSOutputFormatter) Finish(result output_result.OutputResult, output output_formatter_contract2.OutputInterface, input output_formatter_contract2.OutputFormatterInput) error {
