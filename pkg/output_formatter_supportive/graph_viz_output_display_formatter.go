...
func NewGraphVizOutputDisplayFormatter(config configuration.FormatterConfiguration) *GraphVizOutputDisplayFormatter {
...
func (f *GraphVizOutputDisplayFormatter) output(g *graphviz.Graphviz, graph *cgraph.Graph, output output_formatter_contract2.OutputInterface, input output_formatter_contract2.OutputFormatterInput) error {
