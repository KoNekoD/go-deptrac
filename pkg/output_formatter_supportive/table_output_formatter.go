...
func (t *TableOutputFormatter) GetName() output_formatter_contract2.OutputFormatterType {
	return output_formatter_contract2.Table
}

func (t *TableOutputFormatter) Finish(outputResult *output_result.OutputResult, output output_formatter_contract2.OutputInterface, outputFormatterInput *output_formatter_contract2.OutputFormatterInput) error {
	groupedRules := make(map[string][]result_contract2.RuleInterface)
	...
	for _, layer := range groupedRulesLayers {
		...
		slices.SortFunc(rules, func(a, b result_contract2.RuleInterface) int {
...
func (t *TableOutputFormatter) skippedViolationRow(rule *result_contract2.SkippedViolation) []string {
...
func (t *TableOutputFormatter) violationRow(rule *result_contract2.Violation) []string {
	gotDependency := rule.GetDependency()
...
func (t *TableOutputFormatter) formatMultilinePath(dep dependency_contract.DependencyInterface) string {
	lines := make([]string, 0)
...
func (t *TableOutputFormatter) printSummary(result *output_result.OutputResult, output output_formatter_contract2.OutputInterface, reportUncoveredAsError bool) {
	...
	style.DefinitionList(
		[]output_formatter_contract2.StringOrArrayOfStringsOrTableSeparator{
			{String: "Report"},
			{TableSeparator: true},
...
func (t *TableOutputFormatter) uncoveredRow(rule *result_contract2.Uncovered, reportAsError bool) []string {
	gotDependency := rule.GetDependency()
...
func (t *TableOutputFormatter) printErrors(result *output_result.OutputResult, output output_formatter_contract2.OutputInterface) {
...
func (t *TableOutputFormatter) printWarnings(result *output_result.OutputResult, output output_formatter_contract2.OutputInterface) {
